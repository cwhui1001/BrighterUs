                ...
                <div class="filter-panel p-5 bg-light rounded">
                    <form id="filter-form">
                        ...
                        @foreach ($fields as $field)
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="field[]" value="{{ $field->id }}" id="field{{ $field->id }}">
                        ...
                        @foreach ($universities as $university)
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="university[]" value="{{ $university->id }}" id="university{{ $university->id }}">
                        ...
                        @foreach ($locations as $location)
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="location[]" value="{{ $location->id }}" id="location{{ $location->id }}">
                        ...
                        <h4>Budget</h4>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="budget[]" value="5000" id="budget5000">
                            <label class="form-check-label" for="budget5000">Below $5000</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="budget[]" value="10000" id="budget10000">
                            <label class="form-check-label" for="budget10000">Below $10000</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="budget[]" value="20000" id="budget20000">
                            <label class="form-check-label" for="budget20000">Below $20000</label>
                        </div>

                        <h4>Ranking</h4>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="ranking[]" value="10" id="ranking10">
                            <label class="form-check-label" for="ranking10">Top 10</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="ranking[]" value="50" id="ranking50">
                            <label class="form-check-label" for="ranking50">Top 50</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="ranking[]" value="100" id="ranking100">
                            <label class="form-check-label" for="ranking100">Top 100</label>
                        </div>

                        <button type="button" id="apply-filters" class="btn btn-primary mt-3 w-100">Apply Filters</button>
                    </form>
